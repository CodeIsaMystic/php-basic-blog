...
$title = "Dashboard admin Category";
...
<div class="container-fluid bg-light m-0 px-0 py-5">
  <h1 class="display-2 text-center pt-5 m-0">Dashboard: Categories</h1>
  <h5 class="text-center text-black-50 fw-light m-0 pb-5 pt-2">Add some new categories...</h5>
</div>
...
<div class="container-fluid my-5">
  <div class="row mx-0 px-0">
    ...
    <div class="col-md-10 mx-auto">
      <h2 class="text-secondary text-center pt-5 m-0">Welcome to your categories table</h2>
    ...
    <?php if(isset($_GET['created'])): ?>
      <div class="col-md-8 mt-3 px-2 mx-3 mx-md-auto alert alert-success border-0 rounded-0">
        <p class="mb-0">The category has been registered with success.</p>
      </div>
    <?php endif ?>
  
    <!-- ALERT DELETE ACTION  --->
    <?php if(isset($_GET['delete'])): ?>
    <div class="col-md-8 px-2 mx-3 mx-md-auto alert alert-success">
      <p class="mb-0">The category has been deleted with success.</p>
    </div>
    <?php endif ?>

    <!--   TABLE CATEGORIES LISTING  --->  
          ...
          <tr>
            ...
            <td>
              <a class="text-decoration-none text-dark"
                href="<?= $router->url('admin_category', ['id'=> $item->getID()]) ?>">
            ...
            <td class="d-flex justify-content-end border-bottom-0 me-0 me-xl-4">
              ...
              <form method="POST"class="d-inline-block"
                    ...
                    onSubmit="return confirm('Are You sure, you want to delete that category?')">
