...
<head>
  ...
  <title><?= isset($title) ? htmlentities($title) : 'My Site' ?></title>
  ...
  <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav d-flex flex-row mt-3 mt-sm-0 ms-sm-auto">
          <li class="nav-item ms-3">
            <a href="<?= $router->url('home') ?>" class="nav-link text-white fw-light fs-6 pt-2 px-2 px-md-3 mt-1">
              Posts
            </a>
          </li>
          <li class="nav-item">
            <a href="#" class="nav-link text-white fw-light fs-6 pt-2 px-2 px-md-3 mt-1">
              Categories
            </a>
          </li>
          <li class="nav-item">
            <a href="<?= $router->url('login') ?>" class="nav-link text-white text-decoration-none fw-light fs-6 px-2 mt-1 me-4">
              <small>Login</small>
